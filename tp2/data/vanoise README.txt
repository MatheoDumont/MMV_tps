...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=vanoise&box=7.101560,45.696140,6.329882,45.157159
...
-----------
  ...
  * vanoise Height Map (ASTER 30m).png ==> v_height_map.png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * vanoise Height Map (SRTM3 v4.1).png
  ...
  * vanoise Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 297m (actual) is equal to 40m in
